...
export default function EspnSpreadPanel({ onBack }: { onBack: () => void }) {
  ...
  return (
    <div>
      ...
      <h2 style={{ marginTop: 0 }}>ESPN Spreads</h2>
      <p style={{ color: "var(--chalk-dim)", fontSize: "0.85rem", marginTop: 0 }}>
        Pick against ESPN's own spread for each game. One key game each week also needs a
        tiebreaker: predicted total combined points.
      </p>
