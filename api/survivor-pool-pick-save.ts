...
// Saturday 11:59 AM ET of the Saturday most of the week's games actually
// fall on — keep in sync with computeWeekDeadline in
// src/lib/api/survivorPoolPublic.ts, which mirrors this exact function
// for client-side display.
//
// CFBD's own `week` numbering isn't a clean Sun-Sat bucket — 2026's
// week 1 spans Thu Aug 27 through Mon Sep 7, covering both the
...
// landed on Aug 29 — a week early — and locked the whole week's picks
// before most of its games had even been played. Instead, every game's
// start date is mapped to its own week's Saturday, and whichever
